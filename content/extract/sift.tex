...
Each pixel in the DoG pyramid is compared to the $3\times3$ pixels in DoGs below and above, and the $8$ surrounding pixels. This is shown in \figref{fig:DoG_extrema}. The pixel is selected as a key-point candidate if it has a lower or a higher value than all of these $26$ pixels.
